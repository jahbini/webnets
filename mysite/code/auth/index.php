<?php
echo("<h1> TweeParty is not yet ready for Prime Time!</h1>");
die();
...
$consumer_key = 'TqRy6dnFvGJaPa4OeBljQ';
...
switch ($state) {/*{{{*/
  ...
  case 'returned':
    ...
    echo(" Access Token = " . $_SESSION['oauth_access_token'] . " secret token " . $_SESSION['oauth_access_token_secret']);
