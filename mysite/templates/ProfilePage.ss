...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
  ...
  <head>
		<% base_tag %>
		<title>$Title &raquo; Twee Party -- Alpha site. </title>
		$MetaTags(false)
...
<a href="http://www.dreamhost.com/donate.cgi?id=11822"><img border="0" alt="Donate towards my web hosting bill!" src="https://secure.newdream.net/donate4.gif" /></a>
 -->
		...
		<h1 class="papyrus">WeAllTwee</h1>
	    	...
	    	<p>Twitter is a social experience.  It's a party. Bring yourself, talk about important or meaningless things...</p>
	    	<p>It is all good in this tea party of life.  We are just beginning, and hope you can join the chat.  but at the same time, we are just developing this site and it may change radically from day-to-day as we learn how to be socialites!</p>
		</div>
